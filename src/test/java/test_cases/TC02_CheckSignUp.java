...
public class TC02_CheckSignUp extends TestBase{
    ...
    public void signUpNewUser() throws InterruptedException {
        ...
        driver.hideKeyboard();
        Thread.sleep(3000);
        email="shady"+PageBase.generateInteger(9999)+"@gmail.com";
        password="P@ssw0rd";
        signUpPage.fillUserData(driver,"Shady Ahmed","+20120319"+PageBase.generateInteger(9999),"Abu Kabir- El Sharkia - Egypt",email,password,"P@ssw0rd");
